  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-sora text-2xl font-bold text-dark-navy tracking-tight">Welcome back</h1>
        <p className="text-sm text-neutral-gray mt-1.5">Sign in to your Lexinodix Flow workspace</p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-warm-border p-8 shadow-luxury">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2.5 py-3 px-4 bg-warm-surface border border-warm-border rounded-xl hover:bg-warm-hover transition-all duration-200 text-sm font-medium text-dark-navy disabled:opacity-50 group"
          >
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2.5 py-3 px-4 bg-warm-surface border border-warm-border rounded-xl hover:bg-warm-hover transition-all duration-200 text-sm font-medium text-dark-navy disabled:opacity-50"
          >
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-[11px] font-semibold uppercase tracking-wider text-neutral-gray">
                Password
              </label>
              <Link href="/auth/forgot-password" className="text-[11px] text-warm-accent font-bold hover:underline uppercase tracking-wider">
                Forgot?
              </Link>
            </div>
            <input
      ...
      <p className="text-center mt-5 text-sm text-neutral-gray">
        New to Flow?{' '}
        <Link href="/auth/signup" className="text-dark-navy font-semibold hover:underline">
          Create an account
        </Link>
      </p>
    </motion.div>
